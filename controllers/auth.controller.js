...
/* =========================================================
   REFRESH TOKEN CONTROLLER (FIXED: Stable structure)
========================================================= */
...
/* =========================================================
   LOGOUT CONTROLLER (FIXED: Cross-Domain Cookie Clearance)
========================================================= */
export const logout = async (req, res) => {
  try {
    ...
    // FIX: Match original login attributes perfectly so the browser clears the token
    res.clearCookie("refreshToken", {
      httpOnly: true,
      secure: isProd, // Must match original setting
      sameSite: isProd ? "none" : "lax", // Must match original setting to trace cross-origin domains
    });
